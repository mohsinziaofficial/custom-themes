<?php
// Template name: How we can help you
...
<div class="PageWrap MainWrap">
        ...
        <div class="listing-page-header">
            <div class="OpeningContent panel">
                <div class="listings-header">
                    <div class="left-container" style="padding-top: 0 !important;">
                        <div class="TitleWrap">
                    ...
                    <div class="right-container <?php echo (get_the_title() === 'Events & webinars') ? 'events-webinars-right' : ''; ?>">
                        <img src="/wp-content/uploads/2025/07/how-we-can-help.png" alt="" class="listing-header-img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="panel white-bg">
        <div class="flex-container">
            <h3 style="margin-top: 50px;">Our Services</h3>
