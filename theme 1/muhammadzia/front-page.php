	...
	<section class="contentWrap">
		...
		<section class="heroSection">
			<div class="featuredImage">
				...
				<div class="imageTilt">
					<img src="<?php echo $featureImage; ?>" alt="JE Lite Site" style="left: -119.685px; bottom: -111.472px; transition: none;">
				</div>
			</div>
			<div class="container">
		...
		<section class="servicesSection">
			<div class="serviceItem" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/theme-images/service-1.jpg');">
			...
			<div class="serviceItem" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/theme-images/service-2.jpg');">
				<div class="serviceItemDetails">
					<h1 class="title">Lorem <span>Ipsum</span></h1>
					<p class="link"><a class="no-line" href="/insights/">Read More &gt;&gt;</a></p>
				</div>
			</div>
			<div class="serviceItem" style="background-image: url('<?php bloginfo('template_directory'); ?>/assets/theme-images/service-3.jpg');">
				<div class="serviceItemDetails">
					<h1 class="title">Lorem <span>Ipsum</span></h1>
		...
		<section class="aboutSection">
			<div class="container">
				<div class="row">
					...
					<div class="rowCol30">
						<img src="https://litesite4.je-hosting.co.uk/wp-content/uploads/2025/02/arrow-400x400.png">
					</div>
				</div>
			</div>
		</section>
